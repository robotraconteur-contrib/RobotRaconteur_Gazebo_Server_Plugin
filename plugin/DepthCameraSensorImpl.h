...
{
  class DepthCameraSensorImpl : public virtual rrgz::DepthCameraSensor, public virtual SensorImpl
  {
  public:
	  ...
	  virtual RR_SHARED_PTR<rrgz::DepthCameraImage > CaptureImage();

	  virtual RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<rrgz::DepthCameraImage > > > get_ImageStream();
	  virtual void set_ImageStream(RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<rrgz::DepthCameraImage > > > value);


	  virtual std::string RRType() {return "experimental.gazebo.DepthCameraSensor";  }
  protected:
	  sensors::DepthCameraSensorPtr get_camera();
	  RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<rrgz::DepthCameraImage > > > m_ImageStream;
	  RR_SHARED_PTR<RR::PipeBroadcaster<RR_SHARED_PTR<rrgz::DepthCameraImage > > > m_ImageStream_b;
