...
{
  class ForceTorqueSensorImpl : public virtual rrgz::ForceTorqueSensor, public virtual SensorImpl
  {
  public:
	  ...
	  virtual void set_ParentName(std::string value) {SensorImpl::set_ParentName(value);}
  	  ...
  	  virtual RR_SHARED_PTR<RR::RRArray<double> > get_ForceTorque();
  	  virtual void set_ForceTorque(RR_SHARED_PTR<RR::RRArray<double> > value);

  	  virtual RR_SHARED_PTR<RR::Wire<RR_SHARED_PTR<RR::RRArray<double> > > > get_ForceTorqueWire();
  	  virtual void set_ForceTorqueWire(RR_SHARED_PTR<RR::Wire<RR_SHARED_PTR<RR::RRArray<double> > > > value);
  ...
  protected:
      ...
      RR_SHARED_PTR<RR::Wire<RR_SHARED_PTR<RR::RRArray<double> > > > m_ForceTorqueWire;
      RR_SHARED_PTR<RR::WireBroadcaster<RR_SHARED_PTR<RR::RRArray<double> > > > m_ForceTorqueWire_b;
  };
