...
namespace RobotRaconteurGazeboServerPlugin
{
  ...
  public:
	  ...
	  virtual double get_LastMeasurementTime() override {return SensorImpl::get_LastMeasurementTime();}
  	  ...
  	  virtual RR::RRArrayPtr<double> get_ForceTorque() override;  	  

  	  virtual RR::WirePtr<RR::RRArrayPtr<double> > get_ForceTorqueWire();
  	  virtual void set_ForceTorqueWire(RR::WirePtr<RR::RRArrayPtr<double> > value);
  ...
  protected:
      ...
      RR::WirePtr<RR::RRArrayPtr<double> > m_ForceTorqueWire;
      RR::WireBroadcasterPtr<RR::RRArrayPtr<double> > m_ForceTorqueWire_b;
  };
