...
{
  class AltimeterSensorImpl : public virtual rrgz::AltimeterSensor, public virtual SensorImpl
  {
  public:
	  ...
	  virtual void set_ParentName(std::string value) {SensorImpl::set_ParentName(value);}
  	  ...
  	  virtual void set_Altitude(double value);

  	  virtual RR_SHARED_PTR<RR::Wire<double> > get_AltitudeWire();
  	  virtual void set_AltitudeWire(RR_SHARED_PTR<RR::Wire<double> > value);
  ...
  protected:
      ...
      RR_SHARED_PTR<RR::Wire<double> > m_AltitudeWire;
      RR_SHARED_PTR<RR::WireBroadcaster<double> > m_AltitudeWire_b;
  };
