...
namespace RobotRaconteurGazeboServerPlugin
{
  ...
  public:
	  ...
	  virtual rrgz::CameraImagePtr CaptureImage() override;

	  virtual RR::PipePtr<rrgz::CameraImagePtr> get_ImageStream() override;
	  virtual void set_ImageStream(RR::PipePtr<rrgz::CameraImagePtr> value) override;


	  virtual std::string RRType() {return "experimental.gazebo.CameraSensor";  }
  protected:
	  sensors::CameraSensorPtr get_camera();
	  RR::PipePtr<rrgz::CameraImagePtr > m_ImageStream;
	  RR::PipeBroadcasterPtr<rrgz::CameraImagePtr> m_ImageStream_b;
