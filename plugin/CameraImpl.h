...
{
  class CameraImpl : public virtual rrgz::CameraSensor, public virtual SensorImpl
  {
  public:
	  ...
	  virtual RR_SHARED_PTR<rrgz::CameraImage > CaptureImage();

	  virtual RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<rrgz::CameraImage > > > get_ImageStream();
	  virtual void set_ImageStream(RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<rrgz::CameraImage > > > value);


	  virtual std::string RRType() {return "experimental.gazebo.CameraSensor";  }
  protected:
	  sensors::CameraSensorPtr get_camera();
	  RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<rrgz::CameraImage > > > m_ImageStream;
	  RR_SHARED_PTR<RR::PipeBroadcaster<RR_SHARED_PTR<rrgz::CameraImage > > > m_ImageStream_b;
