...
namespace RobotRaconteurGazeboServerPlugin
{
  ...
  public:
	  ...
	  virtual void set_ParentName(std::string value) {SensorImpl::set_ParentName(value);}
  	  ...
  	  virtual RR_SHARED_PTR<rrgz::GpsState> get_ReadState();
  	  virtual void set_ReadState(RR_SHARED_PTR<rrgz::GpsState> value);

  	  virtual RR_SHARED_PTR<RR::Wire<RR_SHARED_PTR<rrgz::GpsState > > > get_StateWire();
  	  virtual void set_StateWire(RR_SHARED_PTR<RR::Wire<RR_SHARED_PTR<rrgz::GpsState > > > value);
  ...
  protected:
      ...
      RR_SHARED_PTR<RR::Wire<RR_SHARED_PTR<rrgz::GpsState > > > m_StateWire;
      RR_SHARED_PTR<RR::WireBroadcaster<RR_SHARED_PTR<rrgz::GpsState > > > m_StateWire_b;
  };
