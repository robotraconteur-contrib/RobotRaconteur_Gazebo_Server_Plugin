...
{
  class MultiCameraSensorImpl : public virtual rrgz::MultiCameraSensor, public virtual SensorImpl
  {
  public:
	  ...
	  virtual int32_t get_CameraCount();
	  virtual void set_CameraCount(int32_t i);

	  virtual RR_SHARED_PTR<rrgz::CameraImage > CaptureImage(int32_t ind);

	  virtual RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<RR::RRMap<int32_t,rrgz::CameraImage > > > > get_ImageStream();
	  virtual void set_ImageStream(RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<RR::RRMap<int32_t,rrgz::CameraImage > > > > value);


	  virtual std::string RRType() {return "experimental.gazebo.MultiCameraSensor";  }
  protected:
	  sensors::MultiCameraSensorPtr get_camera();
	  RR_SHARED_PTR<RR::Pipe<RR_SHARED_PTR<RR::RRMap<int32_t,rrgz::CameraImage > > > > m_ImageStream;
	  RR_SHARED_PTR<RR::PipeBroadcaster<RR_SHARED_PTR<RR::RRMap<int32_t,rrgz::CameraImage > > > > m_ImageStream_b;
