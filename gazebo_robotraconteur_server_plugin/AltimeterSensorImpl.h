...
namespace RobotRaconteurGazeboServerPlugin
{
  ...
  public:
	  ...
	  virtual double get_Altitude() override;  	  

  	  virtual RR::WirePtr<double> get_AltitudeWire() override;
  	  virtual void set_AltitudeWire(RR::WirePtr<double> value) override;
  ...
  protected:
      ...
      RR::WirePtr<double> m_AltitudeWire;
      RR::WireBroadcasterPtr<double> m_AltitudeWire_b;
  };
